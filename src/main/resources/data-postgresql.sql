...
insert into product  values(default, 'Ekran "6,5cala 6/128GB"','Samsung Galaxy S20',3.0,'https://www.mistershopking.com/8877/samsung-galaxy-s20-g980f-8128gb-dual-sim-grey-italia.jpg','skusku',true,1);
insert into product values (default, 'Procesor Intel, 1000GB, 4K display','MacBook Air M1',4.0,'https://www.macworld.com/wp-content/uploads/2021/03/macbook-air-2108-hero2-100779122-orig-7.jpeg?quality=50&strip=all','skuu',true,2);
insert into product values(default, 'Mines bitcoin perfectly','GeForceRTX4090',1.0,'https://techstory.in/wp-content/uploads/2021/12/Newsycanuse-1024x626.jpg','sku321',false,3);
...
insert into opinion values (default, null,'Really bad!',null,1,null,3,1);
