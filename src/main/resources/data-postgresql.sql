...
insert into "user" values (default, true,'admin@admin.com','Uzytkownik','Nr1','$2a$10$Azj6vAZcW7lAKcC5zhQNqurMi3wZHivjLXoWrFq6XyqQqgMeSKEPy','www.zdjecie.pl'); -- Password: admin123 | jwtSecret: mySecretKey
insert into "user" values (default, false,'321@321.com','Uzytkownik2','Nr2','$2a$10$4sMsUd3mETOBM2Zd109Z6.X6v0E0Q7Mul5si3Us0ZQLGtsCXz1qIa','www.test.pl'); -- Password: 12345678 | jwtSecret: mySecretKey
insert into "user" values (default, false,'test@test.gg','User','Testowy','$2a$10$ccpn9Ue5AtrJoIeFVLDLo.HiuPqNbJH08BM0lbxCvr4vE5Qtta7bC','www.www.pl'); -- Password: qwerty123 | jwtSecret: mySecretKey
